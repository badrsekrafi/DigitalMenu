...
app.post("/Settings", async (req, res) => {
    try {
        const { restaurantName, address, phone, openingHours, currency, adminEmail, adminPassword, twoFactorPin } = req.body;
